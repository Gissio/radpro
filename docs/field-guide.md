...
As the atoms disintegrate, they transform into different elements or **isotopes**, often at a predictable rate known as the **half-life**. The half-life is the time it takes for half of the radioactive nuclei in a sample to decay.
...
Scintillation detectors are valued for their fast response times and the ability to determine the energy levels of the radiation (also known as spectroscopy), which allows to identify the source of radiation.
