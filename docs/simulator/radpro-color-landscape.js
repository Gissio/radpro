...
var ASM_CONSTS = {
 ...
 186034: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 186117: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 186186: () => { return window.innerWidth; },  
 186216: () => { return window.innerHeight; }
};
