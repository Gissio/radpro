...
var ASM_CONSTS = {
 ...
 185362: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 185445: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 185514: () => { return window.innerWidth; },  
 185544: () => { return window.innerHeight; }
};
