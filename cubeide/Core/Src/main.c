...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, PWR_EN_Pin|LCD_RESET_Pin|LCD_RS_Pin|LCD_RW_Pin
                          |LCD_EN_Pin|BUZZ_Pin|M_VIB_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = PWR_EN_Pin|LCD_RESET_Pin|LCD_RS_Pin|LCD_RW_Pin
                          |LCD_EN_Pin|BUZZ_Pin|M_VIB_Pin;
