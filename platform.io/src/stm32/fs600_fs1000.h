...
#define APB_FREQUENCY (AHB_FREQUENCY / 2)
#define APBTIM_FREQUENCY (APB_FREQUENCY * 2)
...
#define TUBE_HV_FREQUENCY APBTIM_FREQUENCY
...
#define TUBE_DET_TIMER TIM15
#define TUBE_DET_FREQUENCY APBTIM_FREQUENCY
...
#define DISPLAY_BACKLIGHT_TIMER_PERIOD (APBTIM_FREQUENCY / DISPLAY_BACKLIGHT_TIMER_FREQUENCY)

#define BUZZER_PORT GPIOA
#define BUZZER_PIN 10
#define BUZZER_ACTIVE_LOW
#define BUZZER2_PORT GPIOD
#define BUZZER2_PIN 0
...
#define USART_APB_FREQUENCY APB_FREQUENCY
