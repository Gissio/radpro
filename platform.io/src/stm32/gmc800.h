...
#define BUZZ_EN_PORT GPIOB
#define BUZZ_EN_PIN 1
...
#define DISPLAY_BACKLIGHT_BRIGHTNESS_MAX 0.1F

#define PULSE_GREEN_EN_PORT GPIOB
#define PULSE_GREEN_EN_PIN 3
#define PULSE_RED_EN_PORT GPIOB
#define PULSE_RED_EN_PIN 4

#define VOICE_TX_PORT GPIOA
#define VOICE_TX_PIN 2
#define VOICE_TX_TIMER TIM6
#define VOICE_TX_TIMER_FREQUENCY 5000
#define VOICE_TX_TIMER_PERIOD (APB1TIM_FREQUENCY / DISPLAY_BACKLIGHT_TIMER_FREQUENCY)
...
#define USART_APB_FREQUENCY APB2TIM_FREQUENCY
#define USART_IRQ USART1_IRQn
#define USART_IRQ_HANDLER USART1_IRQHandler
#define USART_RESET_PORT GPIOC
#define USART_RESET_PIN 0
