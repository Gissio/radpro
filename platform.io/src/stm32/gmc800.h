...
#define PULSE_SOUND_EN_PORT GPIOB
#define PULSE_SOUND_EN_PIN 1

#define VOICE_TX_PORT GPIOA
#define VOICE_TX_PIN 2
#define VOICE_TX_TIMER TIM1
#define VOICE_TX_TIMER_FREQUENCY 5000
#define VOICE_TX_TIMER_PERIOD (APB2TIM_FREQUENCY / VOICE_TX_TIMER_FREQUENCY)
#define VOICE_TX_DMA DMA1
#define VOICE_TX_DMA_CHANNEL DMA1_Channel5
...
#define PULSE_LED_EN_PORT GPIOB
#define PULSE_LED_EN_PIN 3
#define ALERT_LED_EN_PORT GPIOB
#define ALERT_LED_EN_PIN 4
