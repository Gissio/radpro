/*
 * Rad Pro
 * Bosean FS-5000 pin definitions
 *
 * (C) 2022-2024 Gissio
 *
 * License: MIT
...
#define TUBE_DET_EXTI_IRQ NVIC_EXTI0_IRQ
#define TUBE_DET_EXTICR_REG SYSCFG_EXTICR1
#define TUBE_DET_EXTICR_VALUE (SYSCFG_EXTICR_GPIOA << (2 * SYSCFG_EXTICR_FIELDSIZE))
#define TUBE_DET_IRQ_HANDLER exti0_isr
...
#define KEY_LEFT_PIN GPIO7
#define KEY_RIGHT_PORT GPIOC
#define KEY_RIGHT_PIN GPIO6
#define KEY_SELECT_PORT GPIOB
#define KEY_SELECT_PIN GPIO15
