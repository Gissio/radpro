...
#define HISTORY_LABEL_MAX_OFFSET_LEFT (HISTORY_LABEL_MAX_WIDTH - PADDING_RIGHT)
...
#define HISTORY_LABEL_PERIOD_OFFSET_LEFT PADDING_LEFT
...
#define HISTORY_LABEL_MIN_OFFSET_LEFT (HISTORY_LABEL_MIN_WIDTH - PADDING_RIGHT)
