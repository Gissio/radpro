...
#define HISTORY_LABEL_MAX_OFFSET_LEFT (HISTORY_LABEL_MAX_WIDTH - (CONTENT_WIDTH - (HISTORY_FRAME_LEFT + HISTORY_FRAME_WIDTH)))
...
#define HISTORY_LABEL_MIN_OFFSET_LEFT (HISTORY_LABEL_MIN_WIDTH - (CONTENT_WIDTH - (HISTORY_FRAME_LEFT + HISTORY_FRAME_WIDTH)))
