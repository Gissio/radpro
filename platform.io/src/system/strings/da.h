...
#define STRING_SOURCE_COMPENSATION "Kildekompensation"
...
#define STRING_DEPLETED_URANIUM "Forarmet uran"
...
#define STRING_PULSEVOLUME "Impulsvolumen"
...
#define STRING_USB_AUTOPOWER_ON "USB auto tænding"
