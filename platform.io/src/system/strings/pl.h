...
#define STRING_POWER_DENSITY "Gęstość mocy"
...
#define STRING_TUBE_DEFAULT "Domyślna rura"
...
#define STRING_USB_AUTO_POWER_ON "USB automatyczne włączanie"
