...
#define STRING_ELECTRIC_FIELD_ALARM "Alarm elektrického poľa"
...
#define STRING_TUBE_DEFAULT "Predvolená trubica"
...
#define STRING_USB_AUTO_POWER_ON "USB automatické zapnutie"
