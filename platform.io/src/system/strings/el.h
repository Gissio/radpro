...
#define STRING_ELECTRIC_FIELD "Ηλεκτρικό πεδίο"
#define STRING_MAGNETIC_FIELD "Μαγνητικό πεδίο"
...
#define STRING_POWER "Τροφοδοσία"
...
#define STRING_ELECTRIC_FIELD_ALARM "Συναγερμός ηλεκτρικού πεδίου"
...
#define STRING_TUBE_DEFAULT "Προεπιλογή σωλήνα"
